    ...
    <div class="outer">
      <div class="inner">
        ...
        <div class="section intro">
          <h2>Get started</h2>
          <span>Try out Rical in seconds</span>
          <br />
          <br />
        ...
        <div class="section">
          <h2>Why Rical?</h2>
          <p>
            Modern calendar apps are too cluttered and slow! If you want these, Rical might be for
            you:
          </p>
          <ul>
        ...
        <img class="full-img" alt="A screenshot of Rical Web" src="/RicalWeb.png"></img>
        <div class="section">
        ...
        <div class="section">
          <h2>Coming soon</h2>
          <p>
            Rical is still in progress and far from complete. Check back soon for more features,
            mark your calendars...
          </p>
          <p>Here's a sneak peek at what's planned:</p>
          <ul>
